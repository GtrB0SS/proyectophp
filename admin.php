    ...
    <body>
        <div class="container">
            <nav class='navbar navbar-light bg-light row'>
                ...
                if (isset($_SESSION['dietaInsertadaExito']) && $_SESSION['dietaInsertadaExito']) {
                    print("<script type='text/javascript'>alert('Dieta insertada con exito');</script>");
                    unset($_SESSION['dietaInsertadaExito']);
                }
                
                if (isset($_SESSION['dietaAsignadaExito']) && $_SESSION['dietaAsignadaExito']) {
                    print("<script type='text/javascript'>alert('Dieta asignada con exito');</script>");
                    unset($_SESSION['dietaAsignadaExito']);
                }
                ...
                if ($_SESSION["especialidad"] == "1" || $_SESSION["especialidad"] == "3") {
                    ...
                    print("<p><a href='dietas/formNuevaDieta.php'>Crear nueva dieta</a></p>");
                    print("<p><a href='dietas/formSelectDietaVisualizar.php'>Ver una dieta</a></p>");
